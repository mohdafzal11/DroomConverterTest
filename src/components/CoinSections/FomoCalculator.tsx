...
const cryptos = [
  { name: 'Bitcoin', symbol: 'btc', icon: '/price/static/icons/btc.svg' },
  { name: 'Ethereum', symbol: 'eth', icon: '/price/static/icons/eth.svg' },
  { name: 'XRP', symbol: 'xrp', icon: '/price/static/icons/xrp.svg' },
  { name: 'Litecoin', symbol: 'ltc', icon: '/price/static/icons/ltc.svg' },
  { name: 'Dogecoin', symbol: 'doge', icon: '/price/static/icons/doge.svg' }
];
